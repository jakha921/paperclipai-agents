...
uni-hrm is a university HR management system built with Django 5.1 + React 19. It has 13 Django apps (accounts, employees, departments, leaves, attendance, payroll, recruitment, appraisal, academic, documents, notifications, integrations, settings) and 25+ frontend pages.
...
- If blocked for more than 2 turns, escalate to the board.
