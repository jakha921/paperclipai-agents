...
- **Feature implementation**: Build features from PM specs with production quality.
- **UI redesign**: Implement TeamHub design system components and page redesigns.
...
- **Database optimization**: No N+1 queries, proper indexing, safe migrations.
- **API design**: RESTful, consistent endpoints with proper serializers.
