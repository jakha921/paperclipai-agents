...
- Ensure N+1 query prevention, proper use of select_related/prefetch_related.
...
- **Technical architecture decisions**: own the system design for Django+React stack.
- **Engineering team coordination**: manage Lead Engineer, QA Engineer, DevOps Engineer.
- **Code review oversight**: ensure quality standards across all PRs.
...
- **SaaS architecture**: multi-tenancy, API versioning, security hardening.
